...
int main(int argc, char* argv[])
{
  ...
  // 2. now we create data a vector of x-values for a simple plot and several
  // sets of y-values for
  ...
  // 3 now we make several plots with different step styles, each one also
  // contains a
