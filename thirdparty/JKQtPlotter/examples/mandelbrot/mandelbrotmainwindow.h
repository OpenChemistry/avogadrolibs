...
protected slots:
  ...
  void plotZoomChangedLocally(double newxmin, double newxmax, double newymin,
...
protected:
  void calculateMandelSet(double rmin, double rmax, double imin, double imax,
...
private:
  ...
  // column for Mandelbrot Set image data, used for calculations
  // (double-buffering with mandelbrot_col_display)
  size_t mandelbrot_col;
  // column for Mandelbrot Set image data, used for display (double-buffering
  // with mandelbrot_col)
