 ...
 * Shows how to plot colored math images/matrices modified by a second
 * data-column/image with JKQTPlotter
 *
...
int main(int argc, char* argv[])
{
  ...
  // 3. make data availJKQTPSTATISTICS_PI to JKQTPlotter by adding it to the
  // internal datastore.
  ...
  // ... and specify which image property is modified (here the saturation, but
  // ModifyAlpha for the transparency and ModifyValue from the HSV color-model
  // are also possible):
