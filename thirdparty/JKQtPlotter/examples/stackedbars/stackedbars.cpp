...
void addGraph(JKQTPlotter& plot, bool swapXY)
{
  ...
  QVector<double> year, percentage_other, percentage_coaloil, percentage_gas,
    percentage_nuclear, percentage_green;
  ...
  //    the variables cYear, cOther ... will contain the internal column ID of
  //    the newly created columns with names "year" and "other" ... and the
  //    (copied) data
  ...
  // 4. create graphs in the plot, which plots the dataset year/other,
  // year/coal, ...
  //    The color of the graphs is set by calling
  //    setFillColor_and_darkenedColor(), which sets the fillColor to the given
  //    color and makes the outline of the bars (i.e. their "color") a darker
