...
int main(int argc, char* argv[])
{
  ...
  // 2. now we add a JKQTPXYFunctionLineGraph object, which will draw a simple
  // function
  ...
  func2->setPlotFunctionFunctor(
    [](double t, const QVector<double>& params) -> QPointF {
      return QPointF(3.0 * sin(params[0] * t + params[2]) + 8.0,
                     3.0 * sin(params[1] * t));
    });
  ...
  func2->setTitle(
    "C++-inline function $[ sin(5{\\cdot}t+\\pi/4), sin(4{\\cdot}t) ]$");
  plot->addGraph(func2);
