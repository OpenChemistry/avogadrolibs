...
sz x v2.2.4.zip -oC:\openchemistry -aoa -r
Invoke-WebRequest -Uri "http://bitbucket.org/eigen/eigen/get/3.3.5.zip" -OutFile "3.3.5.zip"
sz x  3.3.5.zip -oC:\openchemistry -aoa -r
C:\Python35-x64\python.exe C:\openchemistry\avogadrolibs\scripts\appveyor\windows_build_wheels.py
