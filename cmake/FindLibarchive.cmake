...
#  LIBARCHIVE_LIBRARY      - The LIBARCHIVE library
#
find_path(LIBARCHIVE_INCLUDE_DIR libarchive/archive.h)
...
message("LM_SENSORS include dir = ${LIBARCHIVE_INCLUDE_DIR}")
message("LM_SENSORS lib = ${LIBARCHIVE_LIBRARY}")
