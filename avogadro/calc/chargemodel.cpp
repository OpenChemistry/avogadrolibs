...
Array<double> ChargeModel::potentials(Molecule& mol, const Array<Vector3>& points) const {
  // This is naive and slow but can be re-implemented by methods for batching
