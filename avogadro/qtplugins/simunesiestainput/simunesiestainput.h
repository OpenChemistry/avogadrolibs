...
class SimuneSiestaInputDialog;

class SimuneSiestaInput : public QtGui::ExtensionPlugin
{
  Q_OBJECT

public:
  explicit SimuneSiestaInput(QObject *parent = 0);
  ~SimuneSiestaInput();
...
private:
  ...
  SimuneSiestaInputDialog *m_dialog;
