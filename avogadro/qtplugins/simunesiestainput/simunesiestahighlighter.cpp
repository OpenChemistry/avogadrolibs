...
namespace QtPlugins {
  ...
  SimuneSiestaHighlighter::SimuneSiestaHighlighter(QTextDocument *parent_)
      : QSyntaxHighlighter(parent_)
  {
    ...
    m_routeLineCommentFormat.setForeground(Qt::darkMagenta);
    rule.pattern = QRegExp("#[^\n]*");
    rule.format = m_routeLineCommentFormat;
    m_highlightingRules.append(rule);

    m_procsLineCommentFormat.setForeground(Qt::darkMagenta);
    rule.pattern = QRegExp("%[^\n]*");
    rule.format = m_procsLineCommentFormat;
    m_highlightingRules.append(rule);
  ...
  void SimuneSiestaHighlighter::highlightBlock(const QString &text)
  {
