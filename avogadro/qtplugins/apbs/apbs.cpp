...
void Apbs::onOpenOutputFile()
{
  ...
  QtGui::Mesh *positivePotentailMesh = m_molecule->addMesh();
  QtGui::MeshGenerator *positiveMeshGenerator =
    new QtGui::MeshGenerator(positivePotentialCube, positivePotentailMesh, 0.1);
  ...
  QtGui::Mesh *negativePotentailMesh = m_molecule->addMesh();
  QtGui::MeshGenerator *negativeMeshGenerator =
    new QtGui::MeshGenerator(negativePotentialCube, negativePotentailMesh, -0.1);
