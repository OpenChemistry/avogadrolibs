  ...
  , m_molecule(nullptr)
{
  ...
  action->setData("fragment"); // will also work for crystals
...
QStringList InsertFragment::menuPath(QAction*) const
{
...
void InsertFragment::showDialog()
{
  ...
  // check if it was for crystals or fragments

  // Prompt user for input:
  if (!m_dialog) {
    m_dialog = new InsertFragmentDialog(parentAsWidget);
