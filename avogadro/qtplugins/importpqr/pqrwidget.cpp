  ...
  : QDialog(parent), ui(new Ui::PQRWidget)
{
  ...
  connect(ui->searchButton, &QAbstractButton::clicked, this,
          &PQRWidget::searchAction);
  connect(ui->downloadButton, &QAbstractButton::clicked, this,
          &PQRWidget::downloadMol);
  connect(ui->tableWidget, &QTableWidget::cellClicked, this,
          &PQRWidget::molSelected);
