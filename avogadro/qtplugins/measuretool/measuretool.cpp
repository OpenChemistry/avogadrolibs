    ...
    case 3:
      ...
      overlayText +=
        QString("%1 %L2 %L3\n")
          ...
          .arg(angle23 < 360.f ? tr("%L1°").arg(angle23, 10, 'f', 5) : QString(),
               10);
    // fall through
    case 2:
      overlayText +=
        QString("%1 %L2 %L3 %L4")
          ...
          .arg(v2Norm >= 0.f ? tr("%L1 Å").arg(v2Norm, 10, 'f', 5) : QString(), 10)
          .arg(v3Norm >= 0.f ? tr("%L1 Å").arg(v3Norm, 10, 'f', 5) : QString(), 10);
    default:
      break;
  }
