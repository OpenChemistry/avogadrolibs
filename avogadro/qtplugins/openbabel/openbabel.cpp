...
void OpenBabel::onOptimizeGeometry()
{
  ...
  options = OBForceFieldDialog::prompt(qobject_cast<QWidget*>(parent()), ffs,
                                       options, guessDefaultForceField());
...
{
  // Guess forcefield based on molecule. Preference is GAFF, MMFF94s, then UFF.
