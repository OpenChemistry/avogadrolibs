...
def generateInput(optStr):
  # Parse the JSON strings
  opts = json.loads(optStr)

  # Generate the input file
  inp = generateInputFile(opts)

  # Prepare the result
  result = {}
  files = []
  files.append({'job.inp' : inp})
  result['files'] = files
  return result
...
if __name__ == "__main__":
  ...
  parser.add_argument('--generate-input', action='store')
  ...
  if args['print_options']:
    ...
    print json.dumps(generateInput(args['generate_input']))
