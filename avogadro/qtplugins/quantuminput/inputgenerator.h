 ...
 *
 * @note Currently, only chemical JSON representations are supported by setting
 * "inputMoleculeFormat" to "cjson".
 *
 ...
 * <tt>--print-options</tt> output. It will be omitted entirely if
 * "inputMoleculeFormat" is not set. The "options" block contains key/value
