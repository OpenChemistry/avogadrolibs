...
void QuantumInputDialog::saveSingleFile(const QString &fileName)
{
  ...
  if (fatalError) {
    ...
    case 0:
      formattedError =
          tr("The input file cannot be written due to an unknown error.");
      break;
    case 1:
      formattedError =
          tr("The input file cannot be written:\n\n%1").arg(errors.first());
      break;
    default: {
  ...
  if (!errors.isEmpty()) {
    ...
    QMessageBox::StandardButton reply =
        QMessageBox::warning(this, tr("Write input file"), formattedError,
