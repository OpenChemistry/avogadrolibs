...
CrystalLattice::CrystalLattice(QObject *p) : ScenePlugin(p), m_enabled(true)
{
}
...
void CrystalLattice::process(const Molecule &molecule, GroupNode &node)
{
...
bool CrystalLattice::isEnabled() const
{
  return m_enabled;
}

void CrystalLattice::setEnabled(bool enable)
{
  m_enabled = enable;
}
