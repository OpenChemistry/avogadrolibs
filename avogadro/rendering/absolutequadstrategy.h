...
public:
   ...
   * normalized. If this vector is not orthogonal to normal(), it will be
   * projected into the plane defined by normal().
   * @{
   */
...
inline void AbsoluteQuadStrategy::setAlign(AbsoluteQuadStrategy::HAlign h,
                                           AbsoluteQuadStrategy::VAlign v)
{
  setHAlign(h);
  setVAlign(v);
}
