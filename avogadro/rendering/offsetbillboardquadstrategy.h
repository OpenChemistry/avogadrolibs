...
#ifndef AVOGADRO_RENDERING_OFFSETBILLBOARDQUADSTRATEGY_H
#define AVOGADRO_RENDERING_OFFSETBILLBOARDQUADSTRATEGY_H
...
/**
 * @class OffsetBillboardQuadStrategy offsetbillboardquadstrategy.h
 * <avogadro/rendering/offsetbillboardquadstrategy.h>
 * @brief The OffsetBillboardQuadStrategy class positions a resizable quad so
 * that it always faces a Camera and is offset from an anchor point.
 *
 ...
 */
class AVOGADRORENDERING_EXPORT OffsetBillboardQuadStrategy
    : public QuadPlacementStrategy
{
public:
  OffsetBillboardQuadStrategy();
  ~OffsetBillboardQuadStrategy() AVO_OVERRIDE;
   ...
   * @{
   */
  void setUseCameraUp(bool b) { m_strategy.setUseCameraUp(b); }
  bool useCameraUp() const { return m_strategy.useCameraUp(); }
  /** @} */
...
#endif // AVOGADRO_RENDERING_OFFSETBILLBOARDQUADSTRATEGY_H
