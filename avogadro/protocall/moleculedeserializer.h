...
#ifndef MOLECULEDESERIALIZER_H_
#define MOLECULEDESERIALIZER_H_
 ...
 *
 */
class AVOGADROPROTOCALL_EXPORT MoleculeDeserializer : public ProtoCall::Serialization::Deserializer {
public:
  /**
   * @param The molecule to deserialize into.
   */
  MoleculeDeserializer(Avogadro::Core::Molecule *molecule);
