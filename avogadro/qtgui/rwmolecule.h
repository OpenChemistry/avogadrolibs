...
// todo: placeholders for now. Defined after RWMolecule.
struct RWAtom;
struct RWBond;
...
struct AVOGADROQTGUI_EXPORT RWAtom
{
  ...
  bool isValid() const { return m_molecule && m_index < m_molecule->atomCount(); }
...
struct AVOGADROQTGUI_EXPORT RWBond
{
  ...
  RWMolecule* molecule() const { return m_molecule; }
  Index index() const { return m_index; }
  bool isValid() const { return m_molecule && m_index < m_molecule->bondCount(); }
