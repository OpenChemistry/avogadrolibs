                          ...
                          QWidget *)
{
  ...
  QRectF protonNumberRect(-m_width/2 - 10, -m_height/2 + 8,
                          m_width/2, pixelHeight2);
  ...
  QRectF nameRect(-m_width/2, -m_height/2 + 4 + pixelHeight*1.1 + pixelHeight2,
                  m_width, pixelHeight);
  painter->drawText(nameRect, Qt::AlignCenter, name);
#else
  // Draw the proton number
  QRectF protonNumberRect(-m_width/2 - 10, -m_height/2 + 16,
                          m_width/2, pixelHeight2);
  painter->drawText(protonNumberRect, Qt::AlignRight,
                    QString::number(m_element));
